                                ...
                                <div class="col">
                                    <div class="form-group main-section">
                                        <div class="file-loading">
                                            <input id="anexo" type="file" name="anexo" class="file documento_comprobatorio" data-browse-on-zone-click="false" data-overwrite-initial="false" data-min-file-count="2" data-show-preview="false">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="alert alert-silver">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <select name="om_pergunta[]" id="search_to" class="form-control om_pergunta" size="8" multiple="multiple"></select>
                                </div>
            ...
            <div class="col">
                <div class="alert alert-simples">
                    <div class="table-responsive">
                        <table id="pegunta_table" class="table table-sm table-hover table-bordered table-striped dataTable no-footer">
                            <thead>
                                <tr>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea name="descricao" class="form-control" id="descricao_edita" type="text" rows="5" cols="30" dir="ltr" placeholder="Informe sua resposta" required></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="alert alert-silver">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="espacobaixo10"></div>
                                            <button type="button" id="search2_rightAll" class="btn btn-block"><i class="fa fa-forward"></i></button>
                                            <button type="button" id="search2_rightSelected" class="btn btn-block"><i class="fa fa-chevron-right "></i></button>
                                            <button type="button" id="search2_leftSelected" class="btn btn-block"><i class="fa fa-chevron-left"></i></button>
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <select name="om_pergunta[]" id="search2_to" class="form-control om_pergunta" size="8" multiple="multiple"></select>
                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <button type="button" class="btn btn-outline-secondary btn-block" data-dismiss="modal">Cancelar
                        </button>
                    </div>
                </div>
            </div>
...
{{--modal de inativar --}}
<div class="modal fade" id="ModalInativar" tabindex="-1" role="dialog" aria-labelledby="ModalRemoverTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
