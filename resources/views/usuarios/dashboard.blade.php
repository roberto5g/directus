...
<div class="container-fluid">
    <div class="animated fadeIn">
        ...
        <div class="alert alert-secondary">
            <form id="form_resposta_{{$pergunta->id}}" action="/responde/pergunta/{{$pergunta->id}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea name="resposta" class="form-control" id="pergunta_{{$pergunta->id}}" type="text" rows="5" cols="30" dir="ltr" placeholder="Informe sua resposta" required></textarea>
                ...
                <div class="row">
                    <div class="col">
                        <label><b>Anexo referente a pergunta</b></label> <a href="/storage/{{$pergunta->anexo}}" target="_blank"><i class="fa fa-file-text"></i> Anexo</a>
                        ...
                        <div class="col">
                            <div class="form-group main-section">
                                <div class="file-loading">
                                    <input id="anexo_{{$pergunta->id}}" type="file" name="anexo_resposta" class="file documento_comprobatorio" data-browse-on-zone-click="false" data-overwrite-initial="false" data-min-file-count="2" data-show-preview="false">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="alert alert-simples">
            ...
            <div class="table-responsive">
                <table id="perguntas_table" class="table table-sm table-hover table-bordered table-striped dataTable no-footer">
                    <thead>
                        <tr>
...
<div class="modal fade" id="ModalDetalhe" tabindex="-1" role="dialog" aria-labelledby="ModalDetaleTitle" aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea name="resposta" class="form-control" id="resposta" type="text" rows="5" cols="30" dir="ltr" readonly></textarea>
                    ...
                    <div id="anexos">
                        <div class="row">
                            <div class="col" id="anexo_pergunta">
                                <label><b>Anexo referente a pergunta: </b></label> <a id="link_pergunta" href="" target="_blank"><i class="fa fa-file-text"></i> Anexo Pergunta</a>

                            </div>
                            <div class="col" id="anexo_resposta">
                                <label><b>Anexo referente a resposta: </b></label> <a id="link_resposta" href="" target="_blank"><i class="fa fa-file-text"></i> Anexo Resposta</a>
